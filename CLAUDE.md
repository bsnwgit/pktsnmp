...
pktSNMP is an SNMP ingest management and UI platform. It mirrors pktFlow (a NetFlow platform) in look, feel, and shared infrastructure. Port **8767**, app path `/mnt/software/pktsnmp`, server O2 at `SERVER-IP`.
