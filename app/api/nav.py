"""
pktSNMP — Navigation manifest for pktHub's APPS sidebar.

Manifest: GET /api/nav/manifest  → this app's own left-nav, in display order

pktHub mirrors these entries under pktSNMP in its own sidebar and opens each
...
NAV_MANIFEST = [
    ...
    {"path": "/devices",  "label": "Devices",   "icon": "⬡", "admin_only": False},
