...
----------------------------------
Base HTTP client for pktsnmp acting as a suite-token CLIENT of a sibling
...
log = logging.getLogger("pktsnmp.integrations")


class SuiteClient:
    def __init__(self, base_url: str, suite_token: str, suite_user: str = "pktsnmp", suite_role: str = "admin"):
