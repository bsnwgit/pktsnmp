...
src = pathlib.Path(r'C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\pktSNMP')
ts  = datetime.datetime.now().strftime('%Y%m%d_%H%M%S')
dst = pathlib.Path(r'C:\Users\robert.barnett\My Drive\Backups\pktSNMP') / f'pktSNMP_backup_{ts}'
