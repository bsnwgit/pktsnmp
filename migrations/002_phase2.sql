...
VALUES
  ('QTS SW1',     'DEVICE-IP-1',   'medical', 'v3',  '',                 2, 'QTS/SW1',      1),
  ('QTS FW3',     'DEVICE-IP-2',  'medical', 'v2c', 'REDACTED_COMMUNITY_STRING', 2, 'QTS/FW3',      1),
  ('QTS FW4',     'DEVICE-IP-3',  'medical', 'v2c', 'REDACTED_COMMUNITY_STRING', 2, 'QTS/FW4',      1),
  ('OneNeck SW1', 'DEVICE-IP-4', 'medical', 'v2c', 'REDACTED_COMMUNITY_STRING', 2, 'ON/SW1',       1),
  ('OneNeck FW1', 'DEVICE-IP-5',  'medical', 'v2c', 'REDACTED_COMMUNITY_STRING', 2, 'OneNeck/FW1',  1),
  ('OneNeck FW2', 'DEVICE-IP-6',  'medical', 'v2c', 'REDACTED_COMMUNITY_STRING', 2, 'OneNeck/FW2',  1);
