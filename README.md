...
**Port:** `8767` &nbsp;|&nbsp; **App path (O2):** `/mnt/software/pktsnmp` &nbsp;|&nbsp; **Server:** O2 at `172.23.80.5`
...
- SSH key `VyneCorpNetInfra.pem` in a known path
...
```bash
ssh -i VyneCorpNetInfra.pem ec2-user@172.23.80.5
cd /mnt/software
...
Navigate to `http://172.23.80.5:8767` and log in with the default admin credentials set during installation. **Change the password immediately** in Settings → Users.
...
|---|---|---|
| Medical | 172.23.80.11 | QTS SW1 (v3), QTS FW3/FW4 (v2c), OneNeck SW1/FW1/FW2 (v2c) |
| Dental | 10.56.57.181 | AWS AZ2A (10.19.56.186), AWS AZ2B (10.19.81.236) |
...
| `cors_origins` | `["http://172.23.80.5:8767"]` | Allowed CORS origins |
...
2. In Okta, create a SAML app pointing to `http://172.23.80.5:8767/auth/saml/acs`
